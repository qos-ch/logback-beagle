...
public class MenuBuilder {
  ...
  static public Menu buildMenu(VisualElementBuffer visualElementBuffer) {
    ...
    expandCallersMenuItem.setImage(ResourceUtil.getImage(EXPAND_CALLERS_IMG_KEY));
  ...
  static public void addOnMenuSelectionAction(Menu menu, VisualElementBuffer visualElementBuffer) {
    OnMenuSelectionAction onMenuSelectionAction = new OnMenuSelectionAction(visualElementBuffer);
